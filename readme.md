...
| Name | Engine | Link | RGB Camera | Stereo Camera | Low-light Camera | Imaging Sonar | Forward-Looking Sonar | Side-scan Sonar | Multibeam Sonar | DVL | Pressure/Depth | IMU | Contribution |
|------|--------|------|------------|---------------|------------------|---------------|----------------------|-----------------|-----------------|-----|----------------|-----|--------------|
...
| BlueSim | Unreal Engine | [Link](https://github.com/bluerobotics/bluesim) | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ | ✅ | ✅ | Simulator specifically designed for Blue Robotics vehicles with realistic underwater physics and sensor modeling. |

## 🗂️ Datasets

| Name | Link | Size | Images | RGB Camera | Stereo Camera | Low-light Camera | Imaging Sonar | Forward-Looking Sonar | Side-scan Sonar | Multibeam Sonar | DVL | Pressure/Depth | IMU | Contribution |
|------|------|------|--------|------------|---------------|------------------|---------------|----------------------|-----------------|-----------------|-----|----------------|-----|--------------|
...
| AQUALOC | [Link](https://www.lirmm.fr/aqualoc/) | 5.1 GB | 7,965 | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ | Dataset dedicated to underwater localization of vehicles navigating close to the seabed, including camera images, pressure, and inertial data for SLAM and visual-inertial odometry development. |
